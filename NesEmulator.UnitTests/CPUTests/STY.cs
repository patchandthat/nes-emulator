        ...
        public static class STY
        {
            public class ZeroPage
            {
                ...
                public ZeroPage()
                {
                    ...
                    _op = new OpcodeDefinitions().FindOpcode(Operation.STY, AddressMode.ZeroPage);
            ...
            public class ZeroPageX
            {
                ...
                {
                    _memory = A.Fake<IMemory>();
                    _op = new OpcodeDefinitions().FindOpcode(Operation.STY, AddressMode.ZeroPageX);
            ...
            public class Absolute
            {
                ...
                {
                    _memory = A.Fake<IMemory>();
                    _op = new OpcodeDefinitions().FindOpcode(Operation.STY, AddressMode.Absolute);
