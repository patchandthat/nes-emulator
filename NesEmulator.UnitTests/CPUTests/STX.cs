        ...
        public static class STX
        {
            public class ZeroPage
            {
                ...
                public ZeroPage()
                {
                    ...
                    _op = new OpcodeDefinitions().FindOpcode(Operation.STX, AddressMode.ZeroPage);
            ...
            public class ZeroPageY
            {
                ...
                {
                    _memory = A.Fake<IMemory>();
                    _op = new OpcodeDefinitions().FindOpcode(Operation.STX, AddressMode.ZeroPageY);
                ...
                public void WritesValueToCorrectMemoryLocation(byte value, byte yOffset, byte operand, ushort expectedAddress)
                {
                    var sut = CreateSut();
            ...
            public class Absolute
            {
                ...
                {
                    _memory = A.Fake<IMemory>();
                    _op = new OpcodeDefinitions().FindOpcode(Operation.STX, AddressMode.Absolute);
