    ...
    public class ORA
    {
        public class Immediate
        {
            public Immediate()
            {
                ...
                _op = new OpCodes().FindOpcode(Operation.ORA, AddressMode.Immediate);
            ...
            [InlineData(0b0101_0101, 0b1001_1001, 0b1101_1101)]
            ...
            {
                byte accumulator = 0b0000_0000;
                byte operand = 0b0000_0000;
        ...
        public class ZeroPage
        {
            ...
            {
                _memory = A.Fake<IMemory>();
                _op = new OpCodes().FindOpcode(Operation.ORA, AddressMode.ZeroPage);
        ...
        public class ZeroPageX
        {
            ...
            {
                _memory = A.Fake<IMemory>();
                _op = new OpCodes().FindOpcode(Operation.ORA, AddressMode.ZeroPageX);
            ...
            public void ZeroPageWrapAround()
            {
                ...
                sut.Accumulator.Should().Be(0b1111_1111);
                A.CallTo(() => _memory.Read(operandAddress))
                    .MustHaveHappened();
            }
        }
        ...
        public class Absolute
        {
            ...
            {
                _memory = A.Fake<IMemory>();
                _op = new OpCodes().FindOpcode(Operation.ORA, AddressMode.Absolute);
        ...
        public class AbsoluteX
        {
            ...
            {
                _memory = A.Fake<IMemory>();
                _op = new OpCodes().FindOpcode(Operation.ORA, AddressMode.AbsoluteX);
        ...
        public class AbsoluteY
        {
            ...
            {
                _memory = A.Fake<IMemory>();
                _op = new OpCodes().FindOpcode(Operation.ORA, AddressMode.AbsoluteY);
        ...
        public class IndirectX
        {
            ...
            {
                _memory = A.Fake<IMemory>();
                _op = new OpCodes().FindOpcode(Operation.ORA, AddressMode.IndirectX);
            ...
            public void ZeroPageWrap()
            {
                ...
                byte expectedAccumulatorResult = 0b1010_1111;
        ...
        public class IndirectY
        {
            ...
            {
                _memory = A.Fake<IMemory>();
                _op = new OpCodes().FindOpcode(Operation.ORA, AddressMode.IndirectY);
