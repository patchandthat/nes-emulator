        ...
        public static class BVC
        {
            public class Relative
            {
                ...
                public Relative()
                {
                    ...
                    _op = new OpcodeDefinitions().FindOpcode(Operation.BVC, AddressMode.Relative);
                ...
                [Fact]
                public void InstructionPointerIncreasesBy2WhenOverflowIsSet()
                {
                    var sut = CreateSut();
                ...
                [Fact]
                public void ExecutionTakes2CyclesWhenOverflowIsSet()
                {
                    var sut = CreateSut();
                    sut.ForceStatus(StatusFlags.Overflow);
                ...
                [InlineData(38)]
                [InlineData(-25)]
                public void InstructionPointerOffsetByTwoPlusSignedOperandWhenOverflowIsClear(sbyte operand)
                {
                    var sut = CreateSut();
