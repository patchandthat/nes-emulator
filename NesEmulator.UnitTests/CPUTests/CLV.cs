        ...
        public static class CLV
        {
            public class Implicit
            {
                ...
                public Implicit()
                {
                    ...
                    _op = new OpcodeDefinitions().FindOpcode(Operation.CLV, AddressMode.Implicit);
                ...
                public void ShouldClearOverflowFlag(StatusFlags initialFlags)
                {
                    var sut = CreateSut();
                    ...
                    sut.Status.HasFlag(StatusFlags.Overflow).Should().BeFalse();
                }
