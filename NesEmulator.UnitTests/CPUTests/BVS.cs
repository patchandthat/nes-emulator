    ...
    public static class BVS
    {
        public class Relative
        {
            ...
            public Relative()
            {
                ...
                _op = new OpcodeDefinitions().FindOpcode(Operation.BVS, AddressMode.Relative);
            ...
            [Fact]
            public void InstructionPointerIncreasesBy2WhenOverflowIsClear()
            {
                var sut = CreateSut();
            ...
            [Fact]
            public void ExecutionTakes2CyclesWhenOverflowIsClear()
            {
                var sut = CreateSut();
                sut.ForceStatus(StatusFlags.None);
            ...
            [InlineData(38)]
            [InlineData(-25)]
            public void InstructionPointerOffsetByTwoPlusSignedOperandWhenOverflowIsSet(sbyte operand)
            {
                var sut = CreateSut();
                sut.ForceStatus(StatusFlags.Overflow);
