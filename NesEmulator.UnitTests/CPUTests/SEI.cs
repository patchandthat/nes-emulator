        ...
        public static class SEI
        {
            public class Implicit
            {
                ...
                public Implicit()
                {
                    ...
                    _op = new OpcodeDefinitions().FindOpcode(Operation.SEI, AddressMode.Implicit);
                ...
                [InlineData(StatusFlags.None, StatusFlags.InterruptDisable)]
                public void ShouldSetInterruptFlag(StatusFlags initialFlags, StatusFlags expectedFlags)
                {
                    var sut = CreateSut();
