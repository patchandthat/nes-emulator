    ...
    public class DEC
    {
        ...
        public class ZeroPage
        {
            public ZeroPage()
            {
                ...
                _op = new OpCodes().FindOpcode(Operation.DEC, AddressMode.ZeroPage);
        ...
        public class ZeroPageX
        {
            ...
            {
                _memory = A.Fake<IMemory>();
                _op = new OpCodes().FindOpcode(Operation.DEC, AddressMode.ZeroPageX);
            ...
            public void DecrementsCorrectAddress(
                byte operand,
                byte xOffset,
        ...
        public class Absolute
        {
            ...
            {
                _memory = A.Fake<IMemory>();
                _op = new OpCodes().FindOpcode(Operation.DEC, AddressMode.Absolute);
        ...
        public class AbsoluteX
        {
            ...
            {
                _memory = A.Fake<IMemory>();
                _op = new OpCodes().FindOpcode(Operation.DEC, AddressMode.AbsoluteX);
