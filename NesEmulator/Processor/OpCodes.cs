...
{
    internal sealed class OpCodes : IReadOnlyDictionary<byte, OpCode>
    {
            ...
            _inner = new Dictionary<byte, OpCode>
            {
                ...
                },
                {
                    ...
                    new OpCode(0xC6,
                        ...
                        5,
                        StatusFlags.Zero | StatusFlags.Negative,
                        new CPU.IncrementDecrementStrategy())
                },
                {
                    0xD6,
                    new OpCode(0xD6,
